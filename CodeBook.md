...
### Variable and transformation information
...
##Changes to make below variable names more descriptive include:
#long name conversions
- t = time
- f = Frequency
- Acc= Accelerator
- Gyro = Gyroscope
...
###  Additional changes
The final dataset contains summary statistics
Took the average of each variable for each activity and each subject.
